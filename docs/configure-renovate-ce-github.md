...
> [!IMPORTANT]  
> The container running the Renovate CE service requires read, write, and execute (rwx) permissions for the parent folder of the SQLite file. Additionally, the process inside the container executes as UID 1000 and is part of the Docker group with GID 1001.
